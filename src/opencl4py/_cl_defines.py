...
# cl_nv_device_attribute_query extension #defines
...
CL_MEM_USE_UNCACHED_CPU_MEMORY_IMG           = (1 << 26)   #  cl_img_cached_allocations extension flags
CL_MEM_USE_CACHED_CPU_MEMORY_IMG             = (1 << 27)

#  cl_mem_migration_flags - bitfieldF
